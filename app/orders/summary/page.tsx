...
export default function OrdersSummaryListPage() {
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">Open a single order summary from here.</p>
        </div>
      </div>
                  ...
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-blue-700 bg-blue-50 rounded-lg hover:bg-blue-100"
                      >
                        <FaChartLine /> Open Summary
                      </Link>
                    </td>
                  </tr>
                ))}
