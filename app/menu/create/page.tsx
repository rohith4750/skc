        ...
        <div className="p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8 min-h-screen bg-slate-50/50">
            <div className="max-w-3xl mx-auto">
                <div className="mb-6">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Add New Menu Item</h1>
                    <p className="text-slate-500 mt-1">Create a new item for your catering services</p>
                </div>
