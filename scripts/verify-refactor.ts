...
async function main() {
    ...
    if (order.totalAmount.toString() !== '1000.5') { // Prisma Decimal toString might be '1000.5' or '1000.50' depending on input/db
        // Start comparison using Number to be safe or string equality
        // Actually DB is (10, 2), so it should return '1000.50' usually.
        console.log('WARNING: Total amount string mismatch. Expected 1000.50, got', order.totalAmount.toString())
    }
