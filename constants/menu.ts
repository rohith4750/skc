...
export const menuData: RouteConfigItem[] = [
  ...
  },
  {
    name: "Order Hub",
    route: "/orders/center",
    file: "app/orders/center/page.tsx",
    icon: "planner",
    permissions: "AUTHENTICATED",
    showInSideMenu: true,
    section: "core",
  ...
  {
    name: "Store Calculator",
    route: "/expenses/store-calculator",
    file: "app/expenses/store-calculator/page.tsx",
    icon: "store",
    permissions: "SUPER_ADMIN_ONLY",
    showInSideMenu: true,
    section: "financial",
  ...
  {
    name: "Outstanding",
    route: "/workforce/outstanding",
    file: "app/workforce/outstanding/page.tsx",
    icon: "outstanding",
    permissions: "SUPER_ADMIN_ONLY",
    showInSideMenu: true,
    section: "financial",
...
const hiddenAdminRoutes: RouteConfigItem[] = [
  {
    ...
    file: "app/customers/create/page.tsx",
    permissions: "AUTHENTICATED",
    showInSideMenu: false,
  },
  {
    ...
    file: "app/expenses/create/page.tsx",
    permissions: "SUPER_ADMIN_ONLY",
    showInSideMenu: false,
    roles: ["super_admin"],
  },
  {
    ...
    file: "app/inventory/create/page.tsx",
    permissions: "ADMIN_AND_SUPER_ADMIN",
    showInSideMenu: false,
  },
  {
    ...
    route: "/stock/create",
    file: "app/stock/create/page.tsx",
    permissions: "ADMIN_AND_SUPER_ADMIN",
    showInSideMenu: false,
  },
  {
    ...
    file: "app/stock/transaction/page.tsx",
    permissions: "ADMIN_AND_SUPER_ADMIN",
    showInSideMenu: false,
  },
  {
    name: "Create Workforce",
    route: "/workforce/create",
    file: "app/workforce/create/page.tsx",
    permissions: "SUPER_ADMIN_ONLY",
    showInSideMenu: false,
    roles: ["super_admin"],
  },
  ...
  },
  {
    ...
    file: "app/orders/edit/[id]/page.tsx",
    permissions: "AUTHENTICATED",
    showInSideMenu: false,
  },
  {
    ...
    file: "app/orders/summary/page.tsx",
    permissions: "AUTHENTICATED",
    showInSideMenu: false,
  },
  {
    name: "Order Summary Detail",
    route: "/orders/summary/:id",
    file: "app/orders/summary/[id]/page.tsx",
    permissions: "AUTHENTICATED",
    showInSideMenu: false,
  },
  {
    name: "Order Financials",
    route: "/orders/financial",
    file: "app/orders/financial/page.tsx",
    permissions: "AUTHENTICATED",
    showInSideMenu: false,
  },
  {
    name: "Order Financial Detail",
    route: "/orders/financial/:id",
    file: "app/orders/financial/[id]/page.tsx",
    permissions: "AUTHENTICATED",
    showInSideMenu: false,
  },
];
...
export const ALL_ROUTE_CONFIG: RouteConfigItem[] = [
  ...loginRoutes,
  ...adminRoutes,
];
...
export function getRouteConfig(pathname: string): RouteConfigItem | undefined {
  ...
  const exactMatch = ALL_ROUTE_CONFIG.find(
    (item) => normalizePath(item.route) === path,
  );
